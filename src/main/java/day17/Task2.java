...
public class Task2 {
    public static void main(String[] args) {
        ...
        ChessPiece[][] matrice = {
                ...
                {ChessPiece.PAWN_WHITE, ChessPiece.EMPTY, ChessPiece.EMPTY, ChessPiece.QUEEN_WHITE, ChessPiece.EMPTY, ChessPiece.BISHOP_WHITE, ChessPiece.EMPTY, ChessPiece.PAWN_WHITE},
        ...
        ChessBoard chessBoard1 = new ChessBoard(matrice);
        chessBoard1.getChessBoard();
    }
